...
# File structure and files in the project.
# Find the following folders in the root directory of the project zip.
# Backend Service -> backend.zip
# Frontend Service -> frontend.zip
# ML Service -> ml.zip
# StressTest Script -> stressTest folder.
# Google Cloud Function -> GCP_Function.zip

# Instructions to run and deploy services onto google app engine.
Our design consists of 3 services, below is a detailed explanation to deploy our services on GAE. Once you have access to the project 'RoommateRecommender', please ensure that your local google SDK is pointing towards the project 'RoommateRecommender'. Execute the following command to ensure you are pointing to the appropriate project.
